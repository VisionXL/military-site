...
var bitcoinToSatoshis = function bitcoinToSatoshis(amountInBtc) {
  var btc = new Decimal(amountInBtc);
    ...
    return runtime_1.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            amount = new Decimal(amountInCrypto);
            _context4.next = 3;
    ...
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            pepecash = new Decimal(amountInPepecash);
            _context5.next = 3;
            return getPepecashBtcRate();
...
var satoshisToBitcoin = function satoshisToBitcoin(amountInSatoshis) {
  var sats = new Decimal(amountInSatoshis);
    ...
    return runtime_1.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            amt = new Decimal(amountInCurrency);
            _context8.next = 3;
            return getFiatBtcRate(convertFrom);

          case 3:
            rate = _context8.sent;
            evaluatedRate = new Decimal(rate);
...
export { bitcoinToFiat, bitcoinToPepecash, bitcoinToSatoshis, bitcoinToXcp, crytpoToBitcoin, fiatToBitcoin, fiatToSatoshis, getCrypoBtcRate, getFiatBtcRate, getPepecashBtcRate, getXcpBtcRate, pepecashToBitcoin, satoshisToBitcoin, satoshisToFiat, xcpToBitcoin };
//# sourceMappingURL=bitcoin-conversion.esm.js.map
