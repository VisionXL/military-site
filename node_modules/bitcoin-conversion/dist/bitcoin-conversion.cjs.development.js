...
var currencyJs = _interopDefault(require('currency.js'));
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            btc = new decimal_jsLight.Decimal(amountInBtc);
            _context.next = 3;
            return getFiatBtcRate(convertTo);

          case 3:
            rate = _context.sent;
            return _context.abrupt("return", btc.mul(rate).toNumber());
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            pepecashToBtcRate = _context2.sent;
            return _context2.abrupt("return", btc.div(pepecashToBtcRate).toNumber());
...
var bitcoinToSatoshis = function bitcoinToSatoshis(amountInBtc) {
  var btc = new decimal_jsLight.Decimal(amountInBtc);
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            xcpToBtcRate = _context3.sent;
            return _context3.abrupt("return", btc.div(xcpToBtcRate).toNumber());
...
var crytpoToBitcoin = /*#__PURE__*/function () {
    ...
    return runtime_1.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            amount = new decimal_jsLight.Decimal(amountInCrypto);
            _context4.next = 3;
            return getCrypoBtcRate(cryptoCode);

          case 3:
            btcRate = _context4.sent;
            return _context4.abrupt("return", amount.times(btcRate).toNumber());
  ...
  return function crytpoToBitcoin(_x5, _x6) {
    ...
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            pepecash = new decimal_jsLight.Decimal(amountInPepecash);
            _context5.next = 3;
            return getPepecashBtcRate();

          case 3:
            pepecashToBtcRate = _context5.sent;
            return _context5.abrupt("return", pepecash.mul(pepecashToBtcRate).toNumber());
    ...
    return runtime_1.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            xcp = new decimal_jsLight.Decimal(amountInXcp);
            _context6.next = 3;
            return getXcpBtcRate();

          case 3:
            xcpToBtcRate = _context6.sent;
            return _context6.abrupt("return", xcp.mul(xcpToBtcRate).toNumber());
...
var satoshisToBitcoin = function satoshisToBitcoin(amountInSatoshis) {
  var sats = new decimal_jsLight.Decimal(amountInSatoshis);
...
var fiatToBitcoin = /*#__PURE__*/function () {
  var _ref8 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(amountInCurrency, convertFrom) {
    var amt, rate, evaluatedRate;
    return runtime_1.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            amt = new decimal_jsLight.Decimal(amountInCurrency);
            _context8.next = 3;
            return getFiatBtcRate(convertFrom);

          case 3:
            rate = _context8.sent;
            evaluatedRate = new decimal_jsLight.Decimal(rate);
            return _context8.abrupt("return", amt.div(evaluatedRate).toNumber());
...
var getCrypoBtcRate = /*#__PURE__*/function () {
  ...
  return function getCrypoBtcRate(_x15) {
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 10:
            ...
            return _context13.abrupt("return", currencyJs(data.bpi[currency].rate, {
              separator: '',
              symbol: ''
            }).format());
...
exports.bitcoinToFiat = bitcoinToFiat;
exports.bitcoinToPepecash = bitcoinToPepecash;
exports.bitcoinToSatoshis = bitcoinToSatoshis;
exports.bitcoinToXcp = bitcoinToXcp;
exports.crytpoToBitcoin = crytpoToBitcoin;
exports.fiatToBitcoin = fiatToBitcoin;
exports.fiatToSatoshis = fiatToSatoshis;
exports.getCrypoBtcRate = getCrypoBtcRate;
exports.getFiatBtcRate = getFiatBtcRate;
exports.getPepecashBtcRate = getPepecashBtcRate;
exports.getXcpBtcRate = getXcpBtcRate;
exports.pepecashToBitcoin = pepecashToBitcoin;
exports.satoshisToBitcoin = satoshisToBitcoin;
exports.satoshisToFiat = satoshisToFiat;
exports.xcpToBitcoin = xcpToBitcoin;
//# sourceMappingURL=bitcoin-conversion.cjs.development.js.map
